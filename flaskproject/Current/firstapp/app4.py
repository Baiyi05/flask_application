...
@app.route('/')
def index():
    return render_template('index4.html',message='Index')
...
def get_data():
    if 'name' in session.keys() and 'other' in session.keys():
        ...
        return render_template('index4.html',message='No session found.')
...
def remove_cookie():
    response = make_response(render_template('index4.html',message='Cookie removed.'))
